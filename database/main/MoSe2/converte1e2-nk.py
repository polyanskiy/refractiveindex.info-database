...
mpl.rc('font', size=16)
e1=np.loadtxt('mose2-jcv-e1.csv',delimiter=',')
e2=np.loadtxt('mose2-jcv-e2.csv',delimiter=',')
...
plt.subplot(212)
xgrid=np.linspace(evtoum/e1[-1,0],evtoum/e1[1,0],100)
...
np.savetxt('mose2-nk.csv',np.transpose((xgrid,n,k)),)
