...
mpl.rc('font', size=16)
e1=np.loadtxt('mote2-e1.csv',delimiter=',')
e2=np.loadtxt('mote2-e2.csv',delimiter=',')
...
plt.subplot(212)
xgrid=np.linspace(evtoum/e1[-3,0],evtoum/e1[1,0],100)
...
np.savetxt('mote2-nk.csv',np.transpose((xgrid,n,k)),)
